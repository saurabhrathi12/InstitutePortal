...
use institute;
create table student(student_id int not null auto_increment primary key, name char(100) not null, mobile char(10) not null, dateofbirth char(8) not null, address char(100) not null, father_name char(100) not null, mother_name char(100) not null, standard int not null, school char(100) not null);
...
insert into student(name,mobile,dateofbirth,address,father_name,mother_name,standard,school) values('Saurabh Rathi','9657965513','24081997','Shivaji Colony','Bhagirath','Sarla',10,'Saint Paul');
